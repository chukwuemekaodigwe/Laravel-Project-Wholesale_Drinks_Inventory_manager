...
const dateIn = computed(() => props.edit ? props.dateIn : (new Date()))

const saveProduct = props.products
console.log(props)
const products = reactive(saveProduct)
function save() {
    router.post(`/stocks/edit/${props.batch}`, { 'products': products, 'dateIn': dateIn.value })
}
...
<template>
    ...
    <AuthenticatedLayout>
        <template #header>
            <h3 class="font-semibold"> Edit Stocks for Batch </h3>
        </template>
            ...
            <div
                ...
                <div
                    ...
                    <div class="flex py-2 px-2">
                        ...
                        <input type="date" id="small-input" v-model="dateIn"
                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        <tbody>
                            <tr v-for="product in products"
                                ...
                                <td class="px-6 py-4">
                                    <input type="number" id="small-input" v-model="product.total_qty"
                                        class="block w-full p-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 sm:text-xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                </td>
                                <td class="px-6 py-4">
                                    <input type="number" id="small-input" v-model="product.cost_price"
                                        class="block w-full p-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 sm:text-xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                </td>
                                <td class="px-6 py-4">
                                    <input type="number" id="small-input" v-model="product.selling_price"
                                        class="block w-full p-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 sm:text-xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                </td>
                                <td class="px-6 py-4 text-left">
                                    <a href="#" class="font-medium text-green-600 dark:text-green-500 hover:underline">
                                        {{ getProfit(product.cost_price, product.selling_price, 1) }}
                                    </a>
                                </td>
                                <td class="px-6 py-4 text-left">
                                    <a href="#" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">
                                        {{ getProfit(product.cost_price, product.selling_price, product.total_qty) }}
                                    </a>
                                </td>
                            </tr>
